...
public class Sizes {
	...
	public static final float TITLE_HEIGHT = (int)(350 * RESIZE_FACTOR);
	public static final int BOARD_OFFSET = (int)(20 * RESIZE_FACTOR);
	public static final int FIELD_NUMBER = 10;
	public static final int FIELD_SIZE = (int)(500 * RESIZE_FACTOR / FIELD_NUMBER);
	public static final int BOARD_HEIGHT = (int)(540 * RESIZE_FACTOR);
