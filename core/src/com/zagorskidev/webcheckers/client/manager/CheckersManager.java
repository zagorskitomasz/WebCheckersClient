...
import com.zagorskidev.webcheckers.client.controller.GameRequester;
...
public class CheckersManager extends InputAdapter implements GameManager {
	...
	public CheckersManager() {
		...
		requester = new GameRequester();
		controller = new CheckersController(requester);
	...
	public void registerMessagesSender(Messager messager) {
		...
		requester.registerMessagesSender(messager);
	}
